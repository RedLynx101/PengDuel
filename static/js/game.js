...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // New event listener for color inputs
    document.getElementById('player1-color').addEventListener('change', (e) => {
        if (player1) {
            player1.updateColor(e.target.value);
        }
    });

    document.getElementById('player2-color').addEventListener('change', (e) => {
        if (player2) {
            player2.updateColor(e.target.value);
        }
    });
